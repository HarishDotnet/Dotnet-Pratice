...
namespace Authenticator{
    ...
    private string? Profile{
        ...
        static void PrintPasswordCriterias(){
            ...
            Console.WriteLine("\t3. Password should have Atleast 1 LowerCase.");
            Console.WriteLine("\t3. Password should have Atleast 1 Special character.");
            Console.WriteLine("\t3. Password should have Atleast 1 numeric value.");
        }
